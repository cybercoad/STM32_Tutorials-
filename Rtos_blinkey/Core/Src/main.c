...
/* Definitions for BlinkeLED02 */
osThreadId_t BlinkeLED02Handle;
const osThreadAttr_t BlinkeLED02_attributes = {
  .name = "BlinkeLED02",
  .stack_size = 128 * 4,
...
/**
* @brief Function implementing the BlinkeLED02 thread.
* @param argument: Not used
* @retval None
*/
